    ...
    foreach ($foodOrder as $index => $foodId) {
        ...
        foreach ($foodMenu as $foodItem) {
            if ($foodItem['id'] == $foodId) {
                ...
                $totalOrder += $price * $quantity[$index];
                $quantityTotal += $quantity[$index];
                break;
            }
        }
    }
...
<html lang="en">
  ...
  <body>
    ...
    <button id="bookAppointmentBtn" onclick="toggleForm()">Book an Appointment</button>
    <div id="appointmentForm" class="hidden">
        <form method="POST" action="profile.php">
            ...
            <?php foreach ($foodMenu as $foodItem): ?>
                <label>
                    <input type="checkbox" name="foodOrder[]" value="<?php echo $foodItem['id']; ?>" data-price="<?php echo $foodItem['price']; ?>">
                    <?php echo $foodItem['name']; ?> (PHP<?php echo $foodItem['price']; ?>)
                </label>
    ...
    <button id="showAppointmentsBtn" onclick="toggleAppointments()">Show Previous Appointments</button>
    <table id="appointmentsTable" class="hidden">
        <thead>
            <tr>
        ...
        function updateTotalOrder() {
            ...
            checkboxes.forEach(function(checkbox) {
                if (checkbox.checked) {
                    ...
                    var quantityInput = checkbox.parentElement.nextElementSibling;
  ...
  <div class="container py-5">
    <div class="row g-5">
      <div class="col-lg-3 col-md-6">
        ...
        <a class="btn btn-link" href="login.php">Reservation</a>
